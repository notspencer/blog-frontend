...
export default function NewsletterSection() {
  ...
  useEffect(() => {
    ...
    if (newsletterRef.current) {
      newsletterRef.current.addEventListener("mouseenter", handleMouseEnter);
      newsletterRef.current.addEventListener("mouseleave", handleMouseLeave);
    }
  ...
  return (
    ...
    >
      ...
      >
        Tips and debates, news, and inspirational tidbits on sustainability in
        tourism and travel happiness. Subscribe now for exclusive content!
      </motion.p>
